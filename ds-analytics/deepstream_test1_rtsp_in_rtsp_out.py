...
def main(args):
    ...
    #if gie=="nvinfer":
    #    pgie.set_property("config-file-path", "config/dstest1_pgie_config.txt")
    #else:
    #    pgie.set_property("config-file-path", "config/dstest1_pgie_inferserver_config.txt")
    pgie.set_property("config-file-path", "/app/config/nvinfer_detector_config.txt")
    ...
    streammux.link(pgie) # objectg detection
    #pgie.link() # classification
    pgie.link(nvvidconv)
